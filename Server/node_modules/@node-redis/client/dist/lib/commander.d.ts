...
export declare function transformCommandArguments<T>(command: RedisCommand, args: Array<unknown>): {
    args: RedisCommandArguments;
    options: CommandOptions<T> | undefined;
};
export declare function encodeCommand(args: RedisCommandArguments): IterableIterator<RedisCommandArgument>;
